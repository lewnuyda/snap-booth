    ...
    <>
      ...
      >
        ...
        <List>
          ...
          <NavLink to="/booth" className={navItemClass}>
            Snap Booth
          </NavLink>
          ...
          <div className="mt-2">
            ...
            {openUI && (
              <div className="ml-6 mt-2 flex flex-col gap-1">
                <NavLink to="/buttons" className={navItemClass}>
                  Buttons
                </NavLink>
                <NavLink to="/cards" className={navItemClass}>
                  Cards
                </NavLink>
                <NavLink to="/table" className={navItemClass}>
                  Table
                </NavLink>
                <NavLink to="/form-inputs" className={navItemClass}>
                  FormInputs
                </NavLink>
                <NavLink to="/texts" className={navItemClass}>
                  Texts
                </NavLink>
                <NavLink to="/modals" className={navItemClass}>
                  Modals
                </NavLink>
                <NavLink to="/tabs" className={navItemClass}>
                  Tabs
                </NavLink>
              </div>
            )}
